...
<body>
                        ...
                        <div class="hide-scrollbar">
                            <div class="container py-8">
                                ...
                                <div class="card-list">
                                    ...
                                    @php
                                    $letter = $friend->name[0]; //substr($friend->name, 0, 1);
                                    @endphp
                                    ...
                                    <div class="card border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center gx-5">
                                                <div class="col-auto">
                                                    <a href="#" class="avatar ">
                                                        <img class="avatar-img" src="{{ asset('$friend->avatat_url') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="col">
            ...
            <div class="container h-100">
                ...
                <div class="d-flex flex-column h-100 position-relative">
                        ...
                        <div class="row align-items-center">
                                ...
                                <div class="row align-items-center text-center text-xl-start">
                                    ...
                                    <div class="col-12 col-xl-6">
                                        <div class="row align-items-center gx-5">
                                            <div class="col-auto">
                                                <div class="avatar avatar-online">
                                                    <span class="avatar-text" id="chat-avatar"></span>
                                                </div>
                                            </div>
                            ...
                            <div class="col-2 d-xl-none text-end">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-add-members" aria-controls="offcanvas-add-members">Add
                                                members</a>
                                        </li>
                                        <li>
                    ...
                    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                        ...
                        <!-- Chat: Form -->
                        <form class="chat-form rounded-pill bg-dark" id="chat-form" data-emoji-form="" method="post" action="{{ route('api.messages.store') }}">
                            @csrf
                ...
                <div class="text-center py-10">
                    <div class="row gy-6">
                        ...
                        <div class="col-12">
                            ...
                            <p>Bootstrap is an open source <br> toolkit for developing web with <br> HTML, CSS,
                                and
                                JS.
                            </p>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-0">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <button href="" type="submit" class="text text-danger">logout</button>
                            </li>
                        </ul>
                    </form>
                    <!-- List -->
    ...
    <script>
        ...
        var pusher = new Pusher('75636d3052a9bcc485ae', {
            cluster: 'mt1',
