...
<head>
    ...
    <!-- Template CSS -->
    <link class="css-lt" rel="stylesheet" href="{{ asset('assets/css/template.bundle.css') }}"
...
<body id="chat-body">
    ...
    <script src="{{ asset('build/assets/messages-f664ece2.js') }}"></script>
    <script src="{{ asset('build/manifest.json') }}"></script>
    <script src="{{ asset('build/vendor.json') }}"></script>
